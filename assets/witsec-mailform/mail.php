...
$to = "rodrigocanas@gmail.com";														// To Address
$toAlt = "";												// Additional Recipients
$from = "rodrigocanas@gmail.com";													// From Address
$fromName = "Nombre";											// From Name
...
$template = "Hola,<br><br>Se ha recibido un email desde la página web.<br><br>{formdata}<br><br>Fecha {date}<br><br>---<br>Que tenga un buen día.";											// Mail Template
